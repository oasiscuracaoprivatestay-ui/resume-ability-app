...
export const en: Translations = {
  ...
  prem_subtitle: 'Go beyond recovery. Build daily control with deeper support.',
  prem_feat_audio: 'Full audio library',
  prem_feat_audio_desc: 'Access all motivational and preventive audio tracks',
  prem_feat_sessions: 'More guided sessions',
  prem_feat_sessions_desc: 'Longer, deeper audio for stronger focus and recovery',
  prem_feat_daily: 'Daily support expansion',
  prem_feat_daily_desc: 'More Morning, Midday, and Evening sessions',
  prem_feat_ai: 'Smarter support',
  prem_feat_ai_desc: 'Future AI guidance for urges, slips, and recovery',
  prem_feat_book: 'Full method access',
  prem_feat_book_desc: 'Future-ready connection to the complete program and audiobook',
  prem_value: 'This is more than a timer.\nIt is a full support system for prevention, recovery, and consistency.',
  prem_upgrade: 'Unlock Premium',
